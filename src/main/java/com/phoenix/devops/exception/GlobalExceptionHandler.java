...
public class GlobalExceptionHandler {
    ...
    public Result<Nullable> doNotLoginException(NotLoginException ex) {
        return Result.failure(RespEnum.UNAUTHORIZED);
    }

    @ResponseStatus(HttpStatus.FORBIDDEN)
    @ExceptionHandler(NotPermissionException.class)
    public Result<Nullable> doNotPermissionException(NotPermissionException ex) {
