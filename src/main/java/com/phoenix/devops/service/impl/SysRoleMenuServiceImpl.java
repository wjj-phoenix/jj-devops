...
public class SysRoleMenuServiceImpl extends ServiceImpl<SysRoleMenuMapper, SysRoleMenu>  implements ISysRoleMenuService{
    ...
    public SysRoleMenu getOne(QueryWrapper query) {
    ...
    @Override
    @Cacheable(key = "#root.methodName + ':' + #query.toSQL()")
    public List<SysRoleMenu> list(QueryWrapper query) {
    ...
    @Override
    @Deprecated
    public List<SysRoleMenu> listByIds(Collection<? extends Serializable> ids) {
